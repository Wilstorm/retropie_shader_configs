...
python retropie_shader_configs.py fba2012 crtpi 1920 1080
...
python retropie_shader_configs.py fba2012 crtpi 1280 720
...
python retropie_shader_configs.py fba2012 crtpi curvature
...
python retropie_shader_configs.py fba2012 zfast 1920 1080
...
python retropie_shader_configs.py fba2012 zfast 1280 720
...
python retropie_shader_configs.py fba2012 zfast curvature
